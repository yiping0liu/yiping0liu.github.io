...
cpubs:
    ...
    - title:   "Searching for local Pareto optimal solutions: A case study on polygon-based problems"
      ...
      page:    "873-880"
      organization: "IEEE"
      arate:   "39% for oral presentations"
      abbr:    "CEC"
      pdf:     "/pdf/DNEAL.pdf"
...
<table cellpadding="6px">
  <tr valign="top">
    ...
    <b>{{author.name}}</b>{% if pub.cauthor %} <img src="/images/mail.png" align="middle" height="10pxm">{% endif %}{% else %}{{author.name}}{% endif %}{% if forloop.last %}{% else %},{% endif %}{% endfor %}<br />
